...
class AppointmentRepository @Inject constructor(
    ...
    suspend fun getPatientAppointments(id: String) = withContext(dispatcher) {
        val result = appointmentRemoteService.getPatientAppointments(id)
    ...
    suspend fun getCompleteAppointments() = withContext(dispatcher) {
        val result = appointmentRemoteService.getCompleteAppointments()
    ...
    suspend fun paymentAppointment(id: String) = withContext(dispatcher) {
        val result = appointmentRemoteService.paymentAppointment(id)
